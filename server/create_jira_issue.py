...
def create_issue_basic(details: ProjectDetails):
    issue_summary, description_adf = get_issue_description(details)
    ...
    issue_dict = get_issue_dict(issue_summary=issue_summary, description_text=description_adf)
...
def get_issue_dict(issue_summary="Default issue summary, created from python", description_adf={
    "type": "doc",
    "version": 1,
    "content": [
        {
...
def get_issue_description(details: ProjectDetails):
    """
    This function generates an Atlassian Document Format (ADF) dictionary of the issue description, which contains all
    the information needed in order to complete the creation of a Dapla team
    :param details: Contains all required information
    :return: The summary AND a complete ADF issue description containing all information needed to create a Dapla team
    """
        ...
        "content": [
            ...
            },
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "and then run the \"Atlantis apply\" command in the pull request before you merge and delete the branch."
                    }
                ]
            },
            {
